...
class Parser():
    ...
    def _parse(self):
        ...
        self.parser.add_argument(
            '--dataset', type=str, default="poi_num",
            choices=['poi_num', 'commercial_act'],
            help='name of dataset (default: poi_num)')
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            '--filename', type=str, default="./res/GINonStres-H0newatt-ordercntV2-20.txt",
            help='output file')
